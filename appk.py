...
with open("C:/Users/Ayman/Downloads/saved_scaler_linear_new.pkl", 'rb') as model_file:
    model = pickle.load(model_file)

with open("C:/Users/Ayman/Downloads/saved_linear_model_new.pkl", 'rb') as scaler_file:
